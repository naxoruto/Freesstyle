...
describe("Freestyle Stats importer", () => {
  it("builds profile slugs and extracts secondary profile facts", () => {
    ...
    expect(parseFreestyleStatsProfile(`<p>Nombre real Pedro Elias Aquino Cova Nacimiento 16 de noviembre de 1991</p><a href="/competition/god-level-fest/2014">God Level Fest</a>`)).toEqual({
